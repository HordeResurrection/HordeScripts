...
declare namespace HordeResurrection.Game.Render.GeometryCanvas {
	class GeometryCanvas extends System.Object {
		...
		DrawPolyLine(
			points: Stride.Core.Mathematics.Vector2[],
			color: Stride.Core.Mathematics.Color,
			thickness?: number /* = 1 */,
			antiAliased?: boolean /* = true */
		): void;
		...
		AppendBuffers(
			drawBuffer: HordeResurrection.Game.Render.GeometryCanvas.Internal.DrawBuffer
		): void;

		PlaceTemplateAt(
			template: HordeResurrection.Game.Render.GeometryCanvas.Internal.DrawBuffer,
...
declare namespace HordeResurrection.Game.Render.GeometryCanvas {
	abstract class GeometryCanvasRenderHelper {
		...
		static SimpleRenderCanvas(
			canvas: HordeResurrection.Game.Render.GeometryCanvas.GeometryCanvas,
...
declare namespace HordeResurrection.Game.Render.GeometryCanvas.Internal {
	class DrawBuffer extends System.Object {
		...
		// Methods:
		Append(
			otherBuffer: HordeResurrection.Game.Render.GeometryCanvas.Internal.DrawBuffer
		): void;
...
//#region ShowErrorMessageDelegate
declare namespace HordeResurrection.Game.Startup {
	interface /* delegate */ ShowErrorMessageDelegate {
		(
			message: string,
			title: string
		): void;
	...
	class ShowErrorMessageDelegate { constructor(func: ShowErrorMessageDelegate); }
}
//#endregion
...
export const ShowErrorMessageDelegate = HordeResurrection.Game.Startup.ShowErrorMessageDelegate;
export type ShowErrorMessageDelegate = HordeResurrection.Game.Startup.ShowErrorMessageDelegate;
