...
declare namespace HordeResurrection.Engine.Input.UnitSelectors {
	interface /* delegate */ HotkeyEventHandler {
		(
			...
			selectionMode: HordeResurrection.Engine.Logic.Battle.InputSystem.Enums.VirtualSelectUnitsMode
		): void;
	}
...
declare namespace HordeResurrection.Engine.Logic.Battle {
	abstract class BattleController {
		...
		static ReportDesynchronization(
			desyncPlayers: System.Collections.Generic.IEnumerable<HordeResurrection.Engine.Logic.Main.Players.Player>
		): void;
...
declare namespace HordeResurrection.Engine.Logic.Battle.Cheats.Implementations {
	abstract class BaseCheat extends System.Object {
		...
		Execute(
			initiatorPlayer: HordeResurrection.Engine.Logic.Main.Players.Player,
			args: HordeResurrection.Engine.Logic.Battle.Cheats.Arguments.BaseCheatArgs
		): void;
...
declare namespace HordeResurrection.Engine.Logic.Battle.InputSystem.InputFragments {
		...
		extends HordeResurrection.Engine.Logic.Battle.InputSystem.InputFragments.AInputFragment
	{
		// Constructors:
		constructor(
			viiBuilderToCancel: HordeResurrection.Engine.Logic.Battle.InputSystem.InputItemBuilders.AVirtualInputItemBuilder,
...
declare namespace HordeResurrection.Engine.Logic.Battle.InputSystem.InputFragments {
		...
		extends HordeResurrection.Engine.Logic.Battle.InputSystem.InputFragments.AInputFragment
	{
		// Constructors:
		constructor(
			builder: HordeResurrection.Engine.Logic.Battle.InputSystem.InputItemBuilders.AVirtualInputItemBuilder,
...
declare namespace HordeResurrection.Engine.Logic.Battle.InputSystem.InputItemBuilders {
	abstract class AVirtualInputItemBuilder extends System.Object {
		...
		// Methods:
		OnInputFragment(
			inputFragment: HordeResurrection.Engine.Logic.Battle.InputSystem.InputFragments.AInputFragment
		): void;
...
declare namespace HordeResurrection.Engine.Logic.Battle.InputSystem.InputItemBuilders.Factory {
	abstract class FactoryVirtualInputItemBuilderByUnitCommand {
		...
		static CreateByUnitCommand(
			player: HordeResurrection.Engine.Logic.Main.Players.Player,
			unitCommandFragment: HordeResurrection.Engine.Logic.Battle.InputSystem.InputFragments.InputFragmentUnitCommand
		): HordeResurrection.Engine.Logic.Battle.InputSystem.InputItemBuilders.AVirtualInputItemBuilder;
...
declare namespace HordeResurrection.Engine.Logic.Battle.InputSystem.InputItemBuilders {
		...
		extends HordeResurrection.Engine.Logic.Battle.InputSystem.InputItemBuilders.AVirtualInputItemBuilder
	{
		// Constructors:
		constructor(
			p: HordeResurrection.Engine.Logic.Main.Players.Player,
			automaticCommandFragment: HordeResurrection.Engine.Logic.Battle.InputSystem.InputFragments.InputFragmentChangeAutomaticCommandMode
		);
...
declare namespace HordeResurrection.Engine.Logic.Battle.InputSystem.InputItemBuilders {
		...
		extends HordeResurrection.Engine.Logic.Battle.InputSystem.InputItemBuilders.AVirtualInputItemBuilder
	{
		...
		constructor(
			p: HordeResurrection.Engine.Logic.Main.Players.Player,
			dragStartFragment: HordeResurrection.Engine.Logic.Battle.InputSystem.InputFragments.InputFragmentBattleUiMouseDragStart
		);
...
declare namespace HordeResurrection.Engine.Logic.Battle.InputSystem.InputItemBuilders {
		...
		extends HordeResurrection.Engine.Logic.Battle.InputSystem.InputItemBuilders.AVirtualInputItemBuilder
	{
		...
		constructor(
			p: HordeResurrection.Engine.Logic.Main.Players.Player,
			mouseClick: HordeResurrection.Engine.Logic.Battle.InputSystem.InputFragments.InputFragmentBattleUiMouseClick
		);
...
declare namespace HordeResurrection.Engine.Logic.Battle.ReplaySystem {
	class RecordInfo extends System.Object {
		...
		readonly PlayersList: System.Collections.Generic.IReadOnlyList<HordeResurrection.Engine.Logic.Main.Players.ReplayPlayerData>;
...
declare namespace HordeResurrection.Engine.Logic.Battle.ReplaySystem {
		...
		extends HordeResurrection.Engine.Logic.Battle.ReplaySystem.RecordItemBase
	{
		// Constructors:
		constructor(
			inputItem: HordeResurrection.Engine.Logic.Battle.InputSystem.InputItems.AVirtualInputItem
		);
...
declare namespace HordeResurrection.Engine.Logic.Battle.ReplaySystem {
	class ReplayBuffer extends System.Object {
		...
		TryGetRecords(
			...
			/*out*/ records: System.Collections.Generic.List<HordeResurrection.Engine.Logic.Battle.ReplaySystem.RecordItemBase>
		): boolean;
...
declare namespace HordeResurrection.Engine.Logic.Main {
	abstract class MainController {
		...
		static ShowSystemMessage(
			msg: HordeClassLibrary.World.Simple.GameMessage
		): void;
...
declare namespace HordeResurrection.Engine.Logic.Main.Players.Input {
	class PlayerInputBuilder extends System.Object {
		...
		// Constructors:
		constructor(
			owner: HordeResurrection.Engine.Logic.Main.Players.Player
		);
...
declare namespace HordeResurrection.Engine.Logic.Main.Players.Input {
	class PlayerSquadSelector extends System.Object {
		...
		static SelectFromScenaRect(
			...
			squadSelector: HordeResurrection.Engine.Logic.Main.Players.Input.PlayerSquadSelector,
...
declare namespace HordeResurrection.Engine.Logic.Main.Players.Input {
	class PlayerVirtualInput extends System.Object {
		...
		AddLocalScriptInputs(
			viiList: System.Collections.Generic.IEnumerable<HordeResurrection.Engine.Logic.Battle.InputSystem.InputItems.AVirtualInputItem>
		): void;
	}
}
//#endregion
...
declare namespace HordeResurrection.Engine.Logic.Main.Players {
	class Player extends System.Object {
		...
		ToReplayData(): HordeResurrection.Engine.Logic.Main.Players.ReplayPlayerData;
...
export const ReplayPlayerData = HordeResurrection.Engine.Logic.Main.Players.ReplayPlayerData;
export type ReplayPlayerData = HordeResurrection.Engine.Logic.Main.Players.ReplayPlayerData;
