...
import { UnitDirection, PointCommandArgs, UnitCommand, UnitHurtType } from "library/game-logic/horde-types";
...
class Arena {
    ...
    Clear() {
        for (var fieldNum = 0; fieldNum < this.battleFields.length; fieldNum++) {
            ...
            for (var i = 0; i < this.battleFieldsUnits[fieldNum].length; i++) {
                this.battleFieldsUnits[fieldNum][i].BattleMind.InstantDeath(null, UnitHurtType.Mele);
            }
        }
    }
};
