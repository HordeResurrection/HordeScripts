...
import { TileType, Unit, UnitConfig, UnitFlags, UnitSpecification } from "library/game-logic/horde-types";
...
class UnitExperienceSystem {
    ...
    constructor (unit: Unit, baseUnit?: Unit) {
        this.unit                       = unit;
        this.unitDTO                    = ScriptUtils.GetValue(this.unit, "Data");
        this.tickMask                   = unit.PseudoTickCounter % UnitUpdatePeriod;
        this.Cfg_MaxHealth              = unit.Cfg.MaxHealth

        var gameTickNum                 = Battle.GameTimer.GameFramesCounter;
